...
|------------|--------|----------|---------|---------------|--------|-----------|
| **sju-medical-patient-information-system** | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | Python | 16 | `ecfe151` Merge pull request #6 from CSTH-Projects/d... | Melkor | 2h ago |
| **obgyn-patient-information-system**<br><sub>Hospital Information System — internal docs at csth-...</sub> | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | TypeScript | 621 | `c3a69a0` feat(frontend): add nested folder explorer... | Melkor_1 | yesterday |
| **dental-management-system** | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | TypeScript | 37 | `1234808` Merge pull request #6 from CSTH-Projects/E... | Melkor | 3d ago |
...
xychart-beta
    ...
    y-axis "Commits"
    bar [0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 0, 0, 11, 199]
```

```mermaid
xychart-beta horizontal
    title "Commits per Repository (52 Weeks)"
    x-axis ["sju-medical-patient-information-system", "obgyn-patient-information-system", "dental-management-system", "patient-management-init", "OR_Schedule", "schedule-test"]
    y-axis "Commits"
    bar [13, 621, 37, 6, 4, 1]
```
...
|------------|---------------|-----------|
| **sju-medical-patient-information-system** | 13 | Low |
| **obgyn-patient-information-system** | 621 | Very Active |
...
| Merged/Closed Pull Requests | 133 |
| Open Issues | 1 |
| Closed Issues | 3 |
| Security Alerts | 3 |
| Contributors | 6 |
| Languages | Python, TypeScript, PLpgSQL, Shell, CSS, JavaScript, FreeMarker, MDX, +5 more |
| Last Updated | May 04, 2026 at 09:35 UTC |
...
![Python](https://img.shields.io/badge/Python-68.3%25-3776AB?style=flat-square)
![TypeScript](https://img.shields.io/badge/TypeScript-26.2%25-3178C6?style=flat-square)
![PLpgSQL](https://img.shields.io/badge/PLpgSQL-3.2%25-999999?style=flat-square)
![Shell](https://img.shields.io/badge/Shell-0.6%25-89E051?style=flat-square)
...
![FreeMarker](https://img.shields.io/badge/FreeMarker-0.3%25-999999?style=flat-square)
...
| **obgyn-patient-information-system** | 0 | 123 | 0 | 1 | **1** |
...
<sub>Auto-generated on May 04, 2026 at 09:35 UTC.</sub>
