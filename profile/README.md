...
|------------|--------|----------|---------|---------------|--------|-----------|
| **obgyn-patient-information-system**<br><sub>Hospital Information System — internal docs at csth-...</sub> | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | TypeScript | 1,138 | `a52ffab` Merge pull request #268 from CSTH-Projects... | Wansajee | 15h ago |
...
xychart-beta horizontal
    ...
    x-axis ["obgyn-patient-information-system", "sju-medical-patient-information-system", "ot-management-system", "dental-management-system", "OR_Schedule", "schedule-test"]
    y-axis "Commits"
    bar [1138, 18, 34, 37, 4, 1]
```
...
| Last Updated | June 04, 2026 at 15:51 UTC |
...
|------------|------------|--------------|---------------|-----------------|-----------------|
| **obgyn-patient-information-system** | 1 | 247 | 1 | 1 | **1** |
...
<sub>Auto-generated on June 04, 2026 at 15:51 UTC.</sub>
