...
|------------|--------|----------|---------|---------------|--------|-----------|
| **obgyn-patient-information-system**<br><sub>Hospital Information System — internal docs at csth-...</sub> | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | TypeScript | 974 | `ab8a2c7` Merge pull request #245 from CSTH-Projects... | Wansajee | 59m ago |
| **ot-management-system** | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | Python | 34 | `c0d6336` Merge pull request #2 from CSTH-Projects/d... | Wansajee | 2d ago |
...
xychart-beta
    ...
    y-axis "Commits"
    bar [0, 0, 0, 0, 0, 0, 0, 6, 4, 14, 0, 81, 274, 122]
```
...
xychart-beta horizontal
    ...
    y-axis "Commits"
    bar [974, 34, 18, 37, 4, 1]
```

| Repository | Commits (52w) | Frequency |
|------------|---------------|-----------|
| **obgyn-patient-information-system** | 974 | Very Active |
...
![Python](https://img.shields.io/badge/Python-66.2%25-3776AB?style=flat-square)
![TypeScript](https://img.shields.io/badge/TypeScript-28.6%25-3178C6?style=flat-square)
...
|------------|------------|--------------|---------------|-----------------|-----------------|
| **obgyn-patient-information-system** | 0 | 233 | 1 | 1 | **1** |
...
<sub>Auto-generated on May 22, 2026 at 05:57 UTC.</sub>
