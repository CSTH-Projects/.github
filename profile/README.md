...
|------------|--------|----------|---------|---------------|--------|-----------|
| **ot-management-system** | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | Python | 34 | `c0d6336` Merge pull request #2 from CSTH-Projects/d... | Wansajee | 18h ago |
| **obgyn-patient-information-system**<br><sub>Hospital Information System — internal docs at csth-...</sub> | ![Active](https://img.shields.io/badge/Active-brightgreen?style=flat-square) | TypeScript | 1,132 | `4d0893f` Merge pull request #266 from CSTH-Projects... | Wansajee | yesterday |
...
xychart-beta
    ...
    y-axis "Commits"
    bar [0, 0, 0, 0, 0, 0, 0, 0, 1, 8, 0, 19, 226, 124]
```
...
xychart-beta horizontal
    ...
    y-axis "Commits"
    bar [34, 1132, 18, 37, 4, 1]
```

| Repository | Commits (52w) | Frequency |
|------------|---------------|-----------|
| **ot-management-system** | 34 | Occasional |
| **obgyn-patient-information-system** | 1132 | Very Active |
...
![JavaScript](https://img.shields.io/badge/JavaScript-11.2%25-F7DF1E?style=flat-square)
...
| **obgyn-patient-information-system** | 0 | 246 | 1 | 1 | **1** |
...
**obgyn-patient-information-system**: ![TypeScript](https://img.shields.io/badge/TypeScript-49%25-3178C6?style=flat-square) ![JavaScript](https://img.shields.io/badge/JavaScript-23%25-F7DF1E?style=flat-square) ![Python](https://img.shields.io/badge/Python-20%25-3776AB?style=flat-square) ![PLpgSQL](https://img.shields.io/badge/PLpgSQL-5%25-999999?style=flat-square) ![CSS](https://img.shields.io/badge/CSS-1%25-563D7C?style=flat-square)  
...
<sub>Auto-generated on May 31, 2026 at 22:31 UTC.</sub>
